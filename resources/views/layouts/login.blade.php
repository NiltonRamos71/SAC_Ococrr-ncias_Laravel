...
<head>
    ...
    <title>{{ config('app.name', 'Login | CIQ') }}</title>
    ...
    <link rel="shortcut icon" href="{{asset('imagens/favicon_sac.ico')}}" />
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-5">
                        ...
                        <div class="text-center" style="padding-top: 25px; padd ing-bottom: 20px">
                            <a class="navbar-brand" href="{{ url('/') }}">
                                <img src="{{asset('imagens/logo_sac.png')}}" class="logo-default" width="">
                            </a>
                        </div>

                        <div class="text-center" style="padding-top: 30px; padding-bottom: 40px">
                            <h2 style="font-size: 30px; color: white">Controle de Inspeções da Qualidade</h2> 
                        </div>
                        @yield('content')
                    </div>
                </div>
...
<script>
    ...
    function consultaCampo(value, id, msg_error){
        $.ajax({
            ...
            beforeSend: function() {
                $("#load_"+id).append("<img id='load' src='{{asset('imagens/loading.gif')}}'>");
            },
