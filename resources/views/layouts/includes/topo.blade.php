...
<head>
    ...
    <title>{{ config('app.name', 'SAC Ocorrência') }}</title>   
    ...
    <style>
        /* NOME DO ÓRGAO NO MENU HORIZONTAL */
...
<body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
    ...
    @include('layouts.includes.menu_horizontal')

    <div class="clearfix"> </div>

    <div class="page-container">

        @include('layouts.includes.menu_vertical')