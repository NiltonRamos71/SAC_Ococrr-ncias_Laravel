...
<div class="page-footer-fixed text-center" style="background-color: white; padding-top: 20px; padding-bottom: 20px;">
    <div class="page-footer-inner"> {{date('Y')}} © SAC Ocorrências - Secretaria da Administração do Estado da Bahia (<b>SAEB</b>)
...
{{-- <script async src="https://www.googletagmanager.com/gtag/js?id=UA-150221368-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-150221368-1');
</script> --}}
